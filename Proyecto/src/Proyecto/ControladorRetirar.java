     ...
     // and "retira" the money entered in monto from the "cuenta" specified
            ...
            if ("Cuenta".equals(V.textos.get(0).getText()) && "Monto".equals(V.textos.get(1).getText())) {
                ...
                try{
                    ...
                    // Calling Method Retirar(ArrayList<Tarjeta_Debito> TarjetasDB, ArrayList<Tarjeta_Credito> TarjetasTC, Banco Muday, String Valor, String NumeroCuenta)
                    if (op.Retirar(S.getCuentasCD(), S.getCuentasTC(), S.getMuday(), datos[1], datos[0])) {
